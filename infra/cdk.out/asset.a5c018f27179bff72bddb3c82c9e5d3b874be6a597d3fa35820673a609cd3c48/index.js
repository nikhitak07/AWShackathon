...
var init_schemaDeserializationMiddleware = __esm({
  "node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaDeserializationMiddleware.js"() {
    ...
    schemaDeserializationMiddleware = (config) => (next, context) => async (args) => {
      ...
      const [, ns, n5, t5, i5, o5] = operationSchema ?? [];
      try {
        const parsed = await config.protocol.deserializeResponse(operation(ns, n5, t5, i5, o5), {
          ...config,
          ...context
        }, response);
        return {
...
var init_schemaSerializationMiddleware = __esm({
  "node_modules/@smithy/core/dist-es/submodules/schema/middleware/schemaSerializationMiddleware.js"() {
    ...
    schemaSerializationMiddleware = (config) => (next, context) => async (args) => {
      ...
      const request = await config.protocol.serializeRequest(operation(ns, n5, t5, i5, o5), args.input, {
        ...config,
        ...context,
        endpoint
      });
  ...
  "node_modules/@smithy/core/dist-es/submodules/schema/schemas/NormalizedSchema.js"() {
    ...
    NormalizedSchema = class _NormalizedSchema {
      ...
      getMemberSchemas() {
        const buffer = {};
        try {
          for (const [k5, v5] of this.structIterator()) {
            buffer[k5] = v5;
          }
        } catch (ignored) {
        }
      ...
      *structIterator() {
        ...
        it = Array(z2);
        for (let i5 = 0; i5 < z2; ++i5) {
          const k5 = struct2[4][i5];
          const v5 = member([struct2[5][i5], 0], k5);
          yield it[i5] = [k5, v5];
        }
        struct2[anno.it] = it;
      }
  ...
  "node_modules/@smithy/core/dist-es/submodules/schema/TypeRegistry.js"() {
    ...
    TypeRegistry = class _TypeRegistry {
      ...
      copyFrom(other) {
        ...
        for (const [k5, v5] of other.schemas) {
          if (!schemas.has(k5)) {
            schemas.set(k5, v5);
          }
        }
        for (const [k5, v5] of other.exceptions) {
          if (!exceptions.has(k5)) {
            exceptions.set(k5, v5);
          }
        }
      }
...
function __generator(thisArg, body) {
  ...
  function step(op2) {
    ...
    while (g5 && (g5 = 0, op2[0] && (_ = 0)), _) try {
      if (f5 = 1, y2 && (t5 = op2[0] & 2 ? y2["return"] : op2[0] ? y2["throw"] || ((t5 = y2["return"]) && t5.call(y2), 0) : y2.next) && !(t5 = t5.call(y2, op2[1])).done) return t5;
      if (y2 = 0, t5) op2 = [op2[0] & 2, t5.value];
      switch (op2[0]) {
        case 0:
        case 1:
          t5 = op2;
...
function __exportStar(m5, o5) {
  for (var p5 in m5) if (p5 !== "default" && !Object.prototype.hasOwnProperty.call(o5, p5)) __createBinding(o5, m5, p5);
}
...
function __read(o5, n5) {
  ...
  try {
    while ((n5 === void 0 || n5-- > 0) && !(r5 = i5.next()).done) ar.push(r5.value);
  } catch (error2) {
    e5 = { error: error2 };
  } finally {
    try {
...
function __asyncGenerator(thisArg, _arguments, generator) {
  ...
  function awaitReturn(f5) {
    return function(v5) {
      return Promise.resolve(v5).then(f5, reject);
    };
  }
  function verb(n5, f5) {
    if (g5[n5]) {
      i5[n5] = function(v5) {
        return new Promise(function(a5, b5) {
          q5.push([n5, v5, a5, b5]) > 1 || resume(n5, v5);
        });
      };
      if (f5) i5[n5] = f5(i5[n5]);
    }
  }
  ...
  function settle(f5, v5) {
    if (f5(v5), q5.shift(), q5.length) resume(q5[0][0], q5[0][1]);
  }
}
function __asyncDelegator(o5) {
  ...
  function verb(n5, f5) {
    i5[n5] = o5[n5] ? function(v5) {
      return (p5 = !p5) ? { value: __await(o5[n5](v5)), done: false } : f5 ? f5(v5) : v5;
    } : f5;
  }
}
  ...
  "node_modules/tslib/tslib.es6.mjs"() {
    ...
    extendStatics = function(d5, b5) {
      extendStatics = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(d6, b6) {
        ...
        for (var p5 in b6) if (Object.prototype.hasOwnProperty.call(b6, p5)) d6[p5] = b6[p5];
      };
    ...
    __assign = function() {
      __assign = Object.assign || function __assign2(t5) {
        for (var s5, i5 = 1, n5 = arguments.length; i5 < n5; i5++) {
          s5 = arguments[i5];
          for (var p5 in s5) if (Object.prototype.hasOwnProperty.call(s5, p5)) t5[p5] = s5[p5];
        }
        return t5;
      };
    ...
    __setModuleDefault = Object.create ? function(o5, v5) {
    ...
    HttpProtocol = class extends SerdeContext {
      ...
      updateServiceEndpoint(request, endpoint) {
        if ("url" in endpoint) {
          ...
          for (const [k5, v5] of endpoint.url.searchParams.entries()) {
            request.query[k5] = v5;
          }
          if (endpoint.headers) {
            for (const [name, values] of Object.entries(endpoint.headers)) {
...
var require_dist_cjs20 = __commonJS({
  "node_modules/@smithy/util-endpoints/dist-cjs/index.js"(exports2) {
    ...
    var resolveEndpoint5 = (ruleSetObject, options) => {
      const { endpointParams, logger: logger2 } = options;
      const { parameters, rules } = ruleSetObject;
      options.logger?.debug?.(`${debugId} Initial EndpointParams: ${toDebugString(endpointParams)}`);
      const paramsWithDefault = Object.entries(parameters).filter(([, v5]) => v5.default != null).map(([k5, v5]) => [k5, v5.default]);
      if (paramsWithDefault.length > 0) {
        for (const [paramKey, paramDefaultValue] of paramsWithDefault) {
          endpointParams[paramKey] = endpointParams[paramKey] ?? paramDefaultValue;
        }
      }
      const requiredParams = Object.entries(parameters).filter(([, v5]) => v5.required).map(([k5]) => k5);
  ...
  while (encodeStack.length) {
    ...
    if (typeof input === "string") {
      ...
      if (n5 < 24) {
        ...
        data[cursor++] = n5 >> 8;
        data[cursor++] = n5 & 255;
      } else if (n5 < 4294967296) {
        data[cursor++] = major << 5 | extendedFloat32;
        dataView2.setUint32(cursor, n5);
        cursor += 4;
...
var require_dist_cjs25 = __commonJS({
  "node_modules/@smithy/smithy-client/dist-cjs/index.js"(exports2) {
    "use strict";
    var middlewareStack = require_dist_cjs24();
    ...
    var createAggregatedClient5 = (commands5, Client2, options) => {
    ...
    var convertMap = (target) => {
      const output = {};
      for (const [k5, v5] of Object.entries(target || {})) {
        output[k5] = [, v5];
      }
      return output;
    };
      ...
      createReplacer() {
        ...
        return (key, value) => {
          ...
          if (typeof value === "bigint") {
            ...
            const v5 = `${NUMERIC_CONTROL_CHAR + "b" + this.counter++}_` + s5;
...
var require_fxp = __commonJS({
  "node_modules/fast-xml-parser/lib/fxp.cjs"(exports2, module2) {
    ...
    (() => {
      "use strict";
      var t5 = { d: (e6, i6) => {
        for (var n6 in i6) t5.o(i6, n6) && !t5.o(e6, n6) && Object.defineProperty(e6, n6, { enumerable: true, get: i6[n6] });
      ...
      function s5(t6, e6) {
        ...
        for (; n6; ) {
          const s6 = [];
          s6.startIndex = e6.lastIndex - n6[0].length;
          const r6 = n6.length;
          for (let t7 = 0; t7 < r6; t7++) s6.push(n6[t7]);
          i6.push(s6), n6 = e6.exec(t6);
        }
        return i6;
      }
      const r5 = function(t6) {
        return !(null == n5.exec(t6));
      }, o5 = ["hasOwnProperty", "toString", "valueOf", "__defineGetter__", "__defineSetter__", "__lookupGetter__", "__lookupSetter__"], a5 = ["__proto__", "constructor", "prototype"], h5 = { allowBooleanAttributes: false, unpairedTags: [] };
      function l5(t6, e6) {
        e6 = Object.assign({}, h5, e6);
        const i6 = [];
        let n6 = false, s6 = false;
        "\uFEFF" === t6[0] && (t6 = t6.substr(1));
        for (let r6 = 0; r6 < t6.length; r6++) if ("<" === t6[r6] && "?" === t6[r6 + 1]) {
          if (r6 += 2, r6 = u5(t6, r6), r6.err) return r6;
        } else {
          if ("<" !== t6[r6]) {
            if (p5(t6[r6])) continue;
            return b5("InvalidChar", "char '" + t6[r6] + "' is not expected.", w5(t6, r6));
          }
          {
            let o6 = r6;
            if (r6++, "!" === t6[r6]) {
            ...
            }
            {
              ...
              if (h6 = h6.trim(), "/" === h6[h6.length - 1] && (h6 = h6.substring(0, h6.length - 1), r6--), !y2(h6)) {
                let e7;
                return e7 = 0 === h6.trim().length ? "Invalid space after '<'." : "Tag '" + h6 + "' is an invalid name.", b5("InvalidTag", e7, w5(t6, r6));
              }
              const l6 = g5(t6, r6);
              if (false === l6) return b5("InvalidAttr", "Attributes for '" + h6 + "' have open quote.", w5(t6, r6));
              let d6 = l6.value;
              if (r6 = l6.index, "/" === d6[d6.length - 1]) {
                const i7 = r6 - d6.length;
                d6 = d6.substring(0, d6.length - 1);
                const s7 = x5(d6, e6);
                if (true !== s7) return b5(s7.err.code, s7.err.msg, w5(t6, i7 + s7.err.line));
                n6 = true;
              } else if (a6) {
                if (!l6.tagClosed) return b5("InvalidTag", "Closing tag '" + h6 + "' doesn't have proper closing.", w5(t6, r6));
                if (d6.trim().length > 0) return b5("InvalidTag", "Closing tag '" + h6 + "' can't have attributes or invalid starting.", w5(t6, o6));
                if (0 === i6.length) return b5("InvalidTag", "Closing tag '" + h6 + "' has not been opened.", w5(t6, o6));
                {
                  const e7 = i6.pop();
                  if (h6 !== e7.tagName) {
                    let i7 = w5(t6, e7.tagStartPos);
                    return b5("InvalidTag", "Expected closing tag '" + e7.tagName + "' (opened in line " + i7.line + ", col " + i7.col + ") instead of closing tag '" + h6 + "'.", w5(t6, o6));
                  }
                  0 == i6.length && (s6 = true);
                }
              } else {
                const a7 = x5(d6, e6);
                if (true !== a7) return b5(a7.err.code, a7.err.msg, w5(t6, r6 - d6.length + a7.err.line));
                if (true === s6) return b5("InvalidXml", "Multiple possible root nodes found.", w5(t6, r6));
                -1 !== e6.unpairedTags.indexOf(h6) || i6.push({ tagName: h6, tagStartPos: o6 }), n6 = true;
              }
              for (r6++; r6 < t6.length; r6++) if ("<" === t6[r6]) {
                ...
                const e7 = N(t6, r6);
                if (-1 == e7) return b5("InvalidChar", "char '&' is not expected.", w5(t6, r6));
                r6 = e7;
              } else if (true === s6 && !p5(t6[r6])) return b5("InvalidXml", "Extra text at the end", w5(t6, r6));
              "<" === t6[r6] && r6--;
            }
          }
        }
        return n6 ? 1 == i6.length ? b5("InvalidTag", "Unclosed tag '" + i6[0].tagName + "'.", w5(t6, i6[0].tagStartPos)) : !(i6.length > 0) || b5("InvalidXml", "Invalid '" + JSON.stringify(i6.map((t7) => t7.tagName), null, 4).replace(/\r?\n/g, "") + "' found.", { line: 1, col: 1 }) : b5("InvalidXml", "Start tag expected.", 1);
      }
      function p5(t6) {
        return " " === t6 || "	" === t6 || "\n" === t6 || "\r" === t6;
      }
      function u5(t6, e6) {
        ...
        for (; e6 < t6.length; e6++) if ("?" == t6[e6] || " " == t6[e6]) {
          const n6 = t6.substr(i6, e6 - i6);
          if (e6 > 5 && "xml" === n6) return b5("InvalidXml", "XML declaration allowed only at the start of the document.", w5(t6, e6));
          if ("?" == t6[e6] && ">" == t6[e6 + 1]) {
            e6++;
            break;
          }
      ...
      function g5(t6, e6) {
        let i6 = "", n6 = "", s6 = false;
        for (; e6 < t6.length; e6++) {
          if (t6[e6] === d5 || t6[e6] === f5) "" === n6 ? n6 = t6[e6] : n6 !== t6[e6] || (n6 = "");
          else if (">" === t6[e6] && "" === n6) {
            s6 = true;
            break;
          }
        ...
        return "" === n6 && { value: i6, index: e6, tagClosed: s6 };
      }
      const m5 = new RegExp(`(\\s*)([^\\s=]+)(\\s*=)?(\\s*(['"])(([\\s\\S])*?)\\5)?`, "g");
      function x5(t6, e6) {
        const i6 = s5(t6, m5), n6 = {};
        for (let t7 = 0; t7 < i6.length; t7++) {
          if (0 === i6[t7][1].length) return b5("InvalidAttr", "Attribute '" + i6[t7][2] + "' has no space in starting.", v5(i6[t7]));
          if (void 0 !== i6[t7][3] && void 0 === i6[t7][4]) return b5("InvalidAttr", "Attribute '" + i6[t7][2] + "' is without value.", v5(i6[t7]));
          if (void 0 === i6[t7][3] && !e6.allowBooleanAttributes) return b5("InvalidAttr", "boolean attribute '" + i6[t7][2] + "' is not allowed.", v5(i6[t7]));
          const s6 = i6[t7][2];
          if (!E2(s6)) return b5("InvalidAttr", "Attribute '" + s6 + "' is an invalid name.", v5(i6[t7]));
          if (Object.prototype.hasOwnProperty.call(n6, s6)) return b5("InvalidAttr", "Attribute '" + s6 + "' is repeated.", v5(i6[t7]));
          n6[s6] = 1;
        }
        return true;
      }
      ...
      function S(t6, e6) {
        if ("string" != typeof t6) return;
        const i6 = t6.toLowerCase();
        if (o5.some((t7) => i6 === t7.toLowerCase())) throw new Error(`[SECURITY] Invalid ${e6}: "${t6}" is a reserved JavaScript keyword that could cause prototype pollution`);
      ...
      class I2 {
        ...
        readDocType(t6, e6) {
          ...
          {
            e6 += 9;
            let s6 = 1, r6 = false, o6 = false, a6 = "";
            for (; e6 < t6.length; e6++) if ("<" !== t6[e6] || o6) if (">" === t6[e6]) {
            ...
            if (0 !== s6) throw new Error("Unclosed DOCTYPE");
          }
      ...
      class G2 {
        ...
        push(t6, e6 = null, i6 = null) {
          this.path.length > 0 && (this.path[this.path.length - 1].values = void 0);
          const n6 = this.path.length;
          this.siblingStacks[n6] || (this.siblingStacks[n6] = /* @__PURE__ */ new Map());
          const s6 = this.siblingStacks[n6], r6 = i6 ? `${i6}:${t6}` : t6, o6 = s6.get(r6) || 0;
          let a6 = 0;
          for (const t7 of s6.values()) a6 += t7;
          s6.set(r6, o6 + 1);
          const h6 = { tag: t6, position: a6, counter: o6 };
          null != i6 && (h6.namespace = i6), null != e6 && (h6.values = e6), this.path.push(h6);
        }
        pop() {
          if (0 === this.path.length) return;
          const t6 = this.path.pop();
          return this.siblingStacks.length > this.path.length + 1 && (this.siblingStacks.length = this.path.length + 1), t6;
        }
        updateCurrent(t6) {
          if (this.path.length > 0) {
            const e6 = this.path[this.path.length - 1];
            null != t6 && (e6.values = t6);
          }
        }
        getCurrentTag() {
        ...
        hasAttr(t6) {
          ...
          const e6 = this.path[this.path.length - 1];
          return void 0 !== e6.values && t6 in e6.values;
        }
        getPosition() {
        ...
        toString(t6, e6 = true) {
          const i6 = t6 || this.separator;
          return this.path.map((t7) => e6 && t7.namespace ? `${t7.namespace}:${t7.tag}` : t7.tag).join(i6);
        }
        toArray() {
          return this.path.map((t6) => t6.tag);
        }
        reset() {
          this.path = [], this.siblingStacks = [];
        }
        matches(t6) {
          const e6 = t6.segments;
          return 0 !== e6.length && (t6.hasDeepWildcard() ? this._matchWithDeepWildcard(e6) : this._matchSimple(e6));
        }
        _matchSimple(t6) {
          if (this.path.length !== t6.length) return false;
          for (let e6 = 0; e6 < t6.length; e6++) {
            const i6 = t6[e6], n6 = this.path[e6], s6 = e6 === this.path.length - 1;
            if (!this._matchSegment(i6, n6, s6)) return false;
          }
          return true;
        }
        _matchWithDeepWildcard(t6) {
          let e6 = this.path.length - 1, i6 = t6.length - 1;
          for (; i6 >= 0 && e6 >= 0; ) {
            const n6 = t6[i6];
            if ("deep-wildcard" === n6.type) {
              if (i6--, i6 < 0) return true;
              const n7 = t6[i6];
              let s6 = false;
              for (let t7 = e6; t7 >= 0; t7--) {
                const r6 = t7 === this.path.length - 1;
                if (this._matchSegment(n7, this.path[t7], r6)) {
                  e6 = t7 - 1, i6--, s6 = true;
                  break;
                }
              }
              ...
              const t7 = e6 === this.path.length - 1;
              if (!this._matchSegment(n6, this.path[e6], t7)) return false;
              e6--, i6--;
            }
          }
          return i6 < 0;
        }
        _matchSegment(t6, e6, i6) {
          if ("*" !== t6.tag && t6.tag !== e6.tag) return false;
          if (void 0 !== t6.namespace && "*" !== t6.namespace && t6.namespace !== e6.namespace) return false;
          if (void 0 !== t6.attrName) {
            if (!i6) return false;
            if (!e6.values || !(t6.attrName in e6.values)) return false;
            if (void 0 !== t6.attrValue) {
              const i7 = e6.values[t6.attrName];
              if (String(i7) !== String(t6.attrValue)) return false;
            }
          }
          if (void 0 !== t6.position) {
            if (!i6) return false;
            const n6 = e6.counter ?? 0;
            if ("first" === t6.position && 0 !== n6) return false;
            if ("odd" === t6.position && n6 % 2 != 1) return false;
            if ("even" === t6.position && n6 % 2 != 0) return false;
            if ("nth" === t6.position && n6 !== t6.positionValue) return false;
          }
          return true;
        }
        snapshot() {
          return { path: this.path.map((t6) => ({ ...t6 })), siblingStacks: this.siblingStacks.map((t6) => new Map(t6)) };
        }
        restore(t6) {
      ...
      class R {
        ...
        _parse(t6) {
          const e6 = [];
          let i6 = 0, n6 = "";
          for (; i6 < t6.length; ) t6[i6] === this.separator ? i6 + 1 < t6.length && t6[i6 + 1] === this.separator ? (n6.trim() && (e6.push(this._parseSegment(n6.trim())), n6 = ""), e6.push({ type: "deep-wildcard" }), i6 += 2) : (n6.trim() && e6.push(this._parseSegment(n6.trim())), n6 = "", i6++) : (n6 += t6[i6], i6++);
          return n6.trim() && e6.push(this._parseSegment(n6.trim())), e6;
        }
        _parseSegment(t6) {
          const e6 = { type: "tag" };
          let i6 = null, n6 = t6;
          const s6 = t6.match(/^([^\[]+)(\[[^\]]*\])(.*)$/);
          if (s6 && (n6 = s6[1] + s6[3], s6[2])) {
            const t7 = s6[2].slice(1, -1);
            t7 && (i6 = t7);
          }
          let r6, o6, a6 = n6;
          if (n6.includes("::")) {
            const e7 = n6.indexOf("::");
            if (r6 = n6.substring(0, e7).trim(), a6 = n6.substring(e7 + 2).trim(), !r6) throw new Error(`Invalid namespace in pattern: ${t6}`);
          }
          let h6 = null;
          if (a6.includes(":")) {
            const t7 = a6.lastIndexOf(":"), e7 = a6.substring(0, t7).trim(), i7 = a6.substring(t7 + 1).trim();
            ["first", "last", "odd", "even"].includes(i7) || /^nth\(\d+\)$/.test(i7) ? (o6 = e7, h6 = i7) : o6 = a6;
          } else o6 = a6;
          if (!o6) throw new Error(`Invalid segment pattern: ${t6}`);
          if (e6.tag = o6, r6 && (e6.namespace = r6), i6) if (i6.includes("=")) {
            const t7 = i6.indexOf("=");
            e6.attrName = i6.substring(0, t7).trim(), e6.attrValue = i6.substring(t7 + 1).trim();
          } else e6.attrName = i6.trim();
          if (h6) {
            const t7 = h6.match(/^nth\((\d+)\)$/);
            t7 ? (e6.position = "nth", e6.positionValue = parseInt(t7[1], 10)) : e6.position = h6;
          }
          return e6;
        }
        get length() {
      ...
      function Z(t6, e6, i6) {
        if (true !== this.options.ignoreAttributes && "string" == typeof t6) {
          ...
          if (this.options.attributesGroupName) {
            const t7 = {};
            return t7[this.options.attributesGroupName] = o6, t7;
          }
          return o6;
        }
      }
      const J2 = function(t6) {
        ...
        for (let r6 = 0; r6 < t6.length; r6++) if ("<" === t6[r6]) if ("/" === t6[r6 + 1]) {
          ...
          if (this.isCurrentNodeStopNode) {
            let e7 = "";
            if (c6) r6 = s7.closeIndex;
            else if (-1 !== this.options.unpairedTags.indexOf(o6)) r6 = s7.closeIndex;
            else {
              const i7 = this.readStopNodeData(t6, a6, p6 + 1);
      ...
      function Q(t6, e6, i6) {
        ...
        if (n6.allowedTags) {
          const s6 = this.options.jPath ? i6.toString() : i6;
          if (!(Array.isArray(n6.allowedTags) ? n6.allowedTags.includes(e6) : n6.allowedTags(e6, s6))) return t6;
        }
        if (n6.tagFilter) {
          const s6 = this.options.jPath ? i6.toString() : i6;
          if (!n6.tagFilter(e6, s6)) return t6;
        }
        for (const e7 of Object.keys(this.docTypeEntities)) {
          const i7 = this.docTypeEntities[e7], s6 = t6.match(i7.regx);
          if (s6) {
            if (this.entityExpansionCount += s6.length, n6.maxTotalExpansions && this.entityExpansionCount > n6.maxTotalExpansions) throw new Error(`Entity expansion limit exceeded: ${this.entityExpansionCount} > ${n6.maxTotalExpansions}`);
            const e8 = t6.length;
            if (t6 = t6.replace(i7.regx, i7.val), n6.maxExpandedLength && (this.currentExpandedLength += t6.length - e8, this.currentExpandedLength > n6.maxExpandedLength)) throw new Error(`Total expanded content size exceeded: ${this.currentExpandedLength} > ${n6.maxExpandedLength}`);
          }
        }
        for (const e7 of Object.keys(this.lastEntities)) {
          const i7 = this.lastEntities[e7], s6 = t6.match(i7.regex);
          if (s6 && (this.entityExpansionCount += s6.length, n6.maxTotalExpansions && this.entityExpansionCount > n6.maxTotalExpansions)) throw new Error(`Entity expansion limit exceeded: ${this.entityExpansionCount} > ${n6.maxTotalExpansions}`);
          t6 = t6.replace(i7.regex, i7.val);
        }
        if (-1 === t6.indexOf("&")) return t6;
        if (this.options.htmlEntities) for (const e7 of Object.keys(this.htmlEntities)) {
          const i7 = this.htmlEntities[e7], s6 = t6.match(i7.regex);
          if (s6 && (this.entityExpansionCount += s6.length, n6.maxTotalExpansions && this.entityExpansionCount > n6.maxTotalExpansions)) throw new Error(`Entity expansion limit exceeded: ${this.entityExpansionCount} > ${n6.maxTotalExpansions}`);
          t6 = t6.replace(i7.regex, i7.val);
        }
      ...
      function it(t6, e6, i6, n6 = ">") {
        ...
        if (i6) {
          const t7 = h6.indexOf(":");
          -1 !== t7 && (h6 = h6.substr(t7 + 1), l6 = h6 !== s6.data.substr(t7 + 1));
        }
      ...
      function dt(t6, e6, i6, n6) {
        if (e6) {
          ...
          for (let o6 = 0; o6 < r6; o6++) {
            const r7 = s6[o6], a6 = r7.startsWith(n6.attributeNamePrefix) ? r7.substring(n6.attributeNamePrefix.length) : r7, h6 = n6.jPath ? i6.toString() + "." + a6 : i6;
            n6.isArray(r7, h6, true, true) ? t6[r7] = [e6[r7]] : t6[r7] = e6[r7];
          }
        }
      }
      function ft(t6, e6) {
      ...
      function xt(t6, e6, i6, n6, s6) {
        ...
        for (let a6 = 0; a6 < t6.length; a6++) {
          ...
          if (l6 === e6.cdataPropName) {
            o6 && (r6 += i6), r6 += `<![CDATA[${h6[l6][0][e6.textNodeName]}]]>`, o6 = false, n6.pop();
            continue;
          }
          if (l6 === e6.commentPropName) {
            r6 += i6 + `<!--${h6[l6][0][e6.textNodeName]}-->`, o6 = true, n6.pop();
            continue;
          }
          if ("?" === l6[0]) {
      ...
      function Et(t6, e6) {
        ...
        if (t6 && !e6.ignoreAttributes) for (let n6 in t6) {
          ...
          let s6 = t6[n6];
          true === s6 && e6.suppressBooleanAttributes ? i6 += ` ${n6.substr(e6.attributeNamePrefix.length)}` : i6 += ` ${n6.substr(e6.attributeNamePrefix.length)}="${s6}"`;
        }
        return i6;
      }
      function yt(t6) {
      ...
      function At(t6, e6, i6, n6) {
        ...
        if (n6.push(e6, s6), this.checkStopNode(n6)) {
          ...
          return n6.pop(), this.buildObjectNode(s7, e6, r7, i6);
        }
      ...
      St.prototype.build = function(t6) {
        ...
        for (let a6 in t6) if (Object.prototype.hasOwnProperty.call(t6, a6)) if (void 0 === t6[a6]) this.isAttribute(a6) && (s6 += "");
        else if (null === t6[a6]) this.isAttribute(a6) || a6 === this.options.cdataPropName ? s6 += "" : "?" === a6[0] ? s6 += this.indentate(e6) + "<" + a6 + "?" + this.tagEndChar : s6 += this.indentate(e6) + "<" + a6 + "/" + this.tagEndChar;
        else if (t6[a6] instanceof Date) s6 += this.buildTextValNode(t6[a6], a6, "", e6, i6);
        else if ("object" != typeof t6[a6]) {
          const h6 = this.isAttribute(a6);
          if (h6 && !this.ignoreAttributesFn(h6, r6)) n6 += this.buildAttrPairStr(h6, "" + t6[a6], o6);
          else if (!h6) if (a6 === this.options.textNodeName) {
            let e7 = this.options.tagValueProcessor(a6, "" + t6[a6]);
            s6 += this.replaceEntitiesValue(e7);
          } else {
            i6.push(a6);
            const n7 = this.checkStopNode(i6);
            if (i6.pop(), n7) {
              const i7 = "" + t6[a6];
              s6 += "" === i7 ? this.indentate(e6) + "<" + a6 + this.closeTag(a6) + this.tagEndChar : this.indentate(e6) + "<" + a6 + ">" + i7 + "</" + a6 + this.tagEndChar;
            } else s6 += this.buildTextValNode(t6[a6], a6, "", e6, i6);
          }
        } else if (Array.isArray(t6[a6])) {
          const n7 = t6[a6].length;
          let r7 = "", o7 = "";
          for (let h6 = 0; h6 < n7; h6++) {
            const n8 = t6[a6][h6];
            if (void 0 === n8) ;
            else if (null === n8) "?" === a6[0] ? s6 += this.indentate(e6) + "<" + a6 + "?" + this.tagEndChar : s6 += this.indentate(e6) + "<" + a6 + "/" + this.tagEndChar;
            else if ("object" == typeof n8) if (this.options.oneListGroup) {
              i6.push(a6);
              const t7 = this.j2x(n8, e6 + 1, i6);
              i6.pop(), r7 += t7.val, this.options.attributesGroupName && n8.hasOwnProperty(this.options.attributesGroupName) && (o7 += t7.attrStr);
            } else r7 += this.processTextOrObjNode(n8, a6, e6, i6);
            else if (this.options.oneListGroup) {
              let t7 = this.options.tagValueProcessor(a6, n8);
              t7 = this.replaceEntitiesValue(t7), r7 += t7;
            } else {
              i6.push(a6);
              const t7 = this.checkStopNode(i6);
              if (i6.pop(), t7) {
                const t8 = "" + n8;
                r7 += "" === t8 ? this.indentate(e6) + "<" + a6 + this.closeTag(a6) + this.tagEndChar : this.indentate(e6) + "<" + a6 + ">" + t8 + "</" + a6 + this.tagEndChar;
              } else r7 += this.buildTextValNode(n8, a6, "", e6, i6);
            }
          }
          this.options.oneListGroup && (r7 = this.buildObjectNode(r7, a6, o7, e6)), s6 += r7;
        } else if (this.options.attributesGroupName && a6 === this.options.attributesGroupName) {
          const e7 = Object.keys(t6[a6]), i7 = e7.length;
        ...
        if (this.options.attributesGroupName && t6[this.options.attributesGroupName]) {
          const n6 = t6[this.options.attributesGroupName];
          for (let t7 in n6) Object.prototype.hasOwnProperty.call(n6, t7) && (e6[t7.startsWith(this.options.attributeNamePrefix) ? t7.substring(this.options.attributeNamePrefix.length) : t7] = n6[t7], i6 = true);
        } else for (let n6 in t6) {
          if (!Object.prototype.hasOwnProperty.call(t6, n6)) continue;
          const s6 = this.isAttribute(n6);
        ...
        for (let i6 in t6) {
          ...
          const n6 = t6[i6];
          if (i6 === this.options.textNodeName) e6 += n6;
          else if (Array.isArray(n6)) {
            for (let t7 of n6) if ("string" == typeof t7 || "number" == typeof t7) e6 += `<${i6}>${t7}</${i6}>`;
            else if ("object" == typeof t7 && null !== t7) {
              const n7 = this.buildRawContent(t7), s6 = this.buildAttributesForStopNode(t7);
              e6 += "" === n7 ? `<${i6}${s6}/>` : `<${i6}${s6}>${n7}</${i6}>`;
            }
          } else if ("object" == typeof n6 && null !== n6) {
            const t7 = this.buildRawContent(n6), s6 = this.buildAttributesForStopNode(n6);
            e6 += "" === t7 ? `<${i6}${s6}/>` : `<${i6}${s6}>${t7}</${i6}>`;
          } else e6 += `<${i6}>${n6}</${i6}>`;
        }
        return e6;
        ...
        if (this.options.attributesGroupName && t6[this.options.attributesGroupName]) {
          ...
          for (let t7 in i6) {
            if (!Object.prototype.hasOwnProperty.call(i6, t7)) continue;
            const n6 = t7.startsWith(this.options.attributeNamePrefix) ? t7.substring(this.options.attributeNamePrefix.length) : t7, s6 = i6[t7];
            true === s6 && this.options.suppressBooleanAttributes ? e6 += " " + n6 : e6 += " " + n6 + '="' + s6 + '"';
          }
        } else for (let i6 in t6) {
          if (!Object.prototype.hasOwnProperty.call(t6, i6)) continue;
          const n6 = this.isAttribute(i6);
          if (n6) {
            const s6 = t6[i6];
            true === s6 && this.options.suppressBooleanAttributes ? e6 += " " + n6 : e6 += " " + n6 + '="' + s6 + '"';
          }
...
var init_XmlShapeDeserializer = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/XmlShapeDeserializer.js"() {
    "use strict";
    import_xml_builder = __toESM(require_dist_cjs26());
    init_protocols();
    init_schema();
...
var init_parseXmlBody = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/parseXmlBody.js"() {
    "use strict";
    import_xml_builder2 = __toESM(require_dist_cjs26());
...
var init_XmlShapeSerializer = __esm({
  "node_modules/@aws-sdk/core/dist-es/submodules/protocols/xml/XmlShapeSerializer.js"() {
    "use strict";
    import_xml_builder3 = __toESM(require_dist_cjs26());
    init_protocols();
    init_schema();
    init_serde();
    ...
    XmlShapeSerializer = class extends SerdeContextConfig {
      ...
      writeStruct(ns, value, parentXmlns) {
        ...
        if ($unknown && ns.isUnionSchema() && Array.isArray($unknown) && Object.keys(value).length === 1) {
          const [k5, v5] = $unknown;
          const node = import_xml_builder3.XmlNode.of(k5);
          if (typeof v5 !== "string") {
...
var require_dist_cjs28 = __commonJS({
  "node_modules/@smithy/util-retry/dist-cjs/index.js"(exports2) {
    "use strict";
    var serviceErrorClassification = require_dist_cjs27();
...
var require_dist_cjs29 = __commonJS({
  "node_modules/@aws-sdk/middleware-user-agent/dist-cjs/index.js"(exports2) {
    ...
    var utilRetry = require_dist_cjs28();
...
var require_dist_cjs36 = __commonJS({
  "node_modules/@smithy/middleware-endpoint/dist-cjs/index.js"(exports2) {
    ...
    var core = (init_dist_es(), __toCommonJS(dist_es_exports));
    var utilMiddleware = require_dist_cjs6();
    var middlewareSerde = require_dist_cjs35();
...
// node_modules/@aws-sdk/client-textract/dist-cjs/auth/httpAuthSchemeProvider.js
var require_httpAuthSchemeProvider = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/auth/httpAuthSchemeProvider.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.resolveHttpAuthSchemeConfig = exports2.defaultTextractHttpAuthSchemeProvider = exports2.defaultTextractHttpAuthSchemeParametersProvider = void 0;
    var httpAuthSchemes_1 = (init_httpAuthSchemes2(), __toCommonJS(httpAuthSchemes_exports));
    var util_middleware_1 = require_dist_cjs6();
    var defaultTextractHttpAuthSchemeParametersProvider = async (config, context, input) => {
      return {
    ...
    exports2.defaultTextractHttpAuthSchemeParametersProvider = defaultTextractHttpAuthSchemeParametersProvider;
    ...
    var defaultTextractHttpAuthSchemeProvider = (authParameters) => {
      const options = [];
    ...
    exports2.defaultTextractHttpAuthSchemeProvider = defaultTextractHttpAuthSchemeProvider;
...
var require_package = __commonJS({
  "node_modules/@aws-sdk/client-textract/package.json"(exports2, module2) {
    module2.exports = {
  ...
  "node_modules/@aws-sdk/credential-provider-http/dist-cjs/fromHttp/requestHelpers.js"(exports2) {
    ...
    function createGetRequest(url) {
      return new protocol_http_1.HttpRequest({
        ...
        path: url.pathname,
        query: Array.from(url.searchParams.entries()).reduce((acc, [k5, v5]) => {
          acc[k5] = v5;
          return acc;
        }, {}),
        fragment: url.hash
...
var init_runtimeConfig = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/runtimeConfig.js"() {
    ...
    import_util_retry = __toESM(require_dist_cjs28());
...
var init_CreateTokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/commands/CreateTokenCommand.js"() {
    ...
    init_EndpointParameters();
    init_schemas_0();
    CreateTokenCommand = class extends import_smithy_client13.Command.classBuilder().ep(commonParams).m(function(Command, cs, config, o5) {
      ...
      rules: [
        {
          ...
          rules: [
            { conditions: r2, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d2 },
            { conditions: s2, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d2 },
            { endpoint: { url: k2, properties: n2, headers: n2 }, type: e2 }
          ],
          type: f2
        },
        {
          conditions: [{ [v2]: b2, [w2]: t2 }],
          rules: [
            {
              conditions: [{ [v2]: "aws.partition", [w2]: t2, assign: g2 }],
              rules: [
                {
                  conditions: [l2, m2],
                  rules: [
                    {
                      conditions: [{ [v2]: c2, [w2]: [a2, o2] }, q2],
                      rules: [
                        {
                          endpoint: {
                    ...
                    { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d2 }
                  ],
                  type: f2
                },
                {
                  ...
                  rules: [
                    ...
                    { error: "FIPS is enabled but this partition does not support FIPS", type: d2 }
                  ],
                  type: f2
                },
                {
                  ...
                  rules: [
                    ...
                    { error: "DualStack is enabled but this partition does not support DualStack", type: d2 }
                  ],
                  type: f2
                },
                {
        ...
        { error: "Invalid Configuration: Missing Region", type: d2 }
      ]
    };
    ruleSet2 = _data2;
  }
...
var init_runtimeConfig2 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeConfig.js"() {
    ...
    import_util_retry2 = __toESM(require_dist_cjs28());
...
var init_GetRoleCredentialsCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/commands/GetRoleCredentialsCommand.js"() {
    ...
    init_EndpointParameters2();
    init_schemas_02();
    GetRoleCredentialsCommand = class extends import_smithy_client20.Command.classBuilder().ep(commonParams2).m(function(Command, cs, config, o5) {
...
var init_ruleset3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/endpoint/ruleset.js"() {
    ...
    n3 = {};
    o3 = { [v3]: "getAttr", [w3]: [{ [x3]: g3 }, "name"] };
    p3 = { [v3]: c3, [w3]: [{ [x3]: "UseFIPS" }, false] };
    q3 = { [v3]: c3, [w3]: [{ [x3]: "UseDualStack" }, false] };
    r3 = { [v3]: "getAttr", [w3]: [{ [x3]: g3 }, "supportsFIPS"] };
    s3 = { [v3]: c3, [w3]: [true, { [v3]: "getAttr", [w3]: [{ [x3]: g3 }, "supportsDualStack"] }] };
    t3 = [{ [x3]: "Region" }];
    _data3 = {
      version: "1.0",
      parameters: { UseDualStack: i3, UseFIPS: i3, Endpoint: j3, Region: j3 },
      rules: [
        {
          conditions: [{ [v3]: b3, [w3]: [k3] }],
          rules: [
            { conditions: [l3], error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d3 },
            {
              rules: [
                {
                  conditions: [m3],
                ...
                { endpoint: { url: k3, properties: n3, headers: n3 }, type: e3 }
              ],
              type: f3
            }
          ],
        ...
        },
        {
          rules: [
                  ...
                  rules: [
                    ...
                    },
                    {
                      ...
                      rules: [
                        ...
                        { error: "FIPS is enabled but this partition does not support FIPS", type: d3 }
                      ],
                      type: f3
                    },
                    {
                      ...
                      rules: [
                        ...
                        { error: "DualStack is enabled but this partition does not support DualStack", type: d3 }
                      ],
                      type: f3
                    },
                    {
                      endpoint: { url: "https://signin.{Region}.{PartitionResult#dnsSuffix}", properties: n3, headers: n3 },
                      type: e3
                    }
                  ],
                  type: f3
            ...
            { error: "Invalid Configuration: Missing Region", type: d3 }
          ],
          type: f3
        }
      ]
...
var init_runtimeConfig3 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/runtimeConfig.js"() {
    ...
    import_util_retry3 = __toESM(require_dist_cjs28());
...
var init_CreateOAuth2TokenCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/commands/CreateOAuth2TokenCommand.js"() {
    ...
    init_EndpointParameters3();
    init_schemas_03();
    CreateOAuth2TokenCommand = class extends import_smithy_client27.Command.classBuilder().ep(commonParams3).m(function(Command, cs, config, o5) {
...
var init_ruleset4 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/endpoint/ruleset.js"() {
    ...
    l4 = "getAttr";
    m4 = { [F]: false, [G]: "string" };
    n4 = { [F]: true, default: false, [G]: "boolean" };
    o4 = { [J]: "Endpoint" };
    p4 = { [H]: "isSet", [I]: [{ [J]: "Region" }] };
    q4 = { [J]: "Region" };
    r4 = { [H]: "aws.partition", [I]: [q4], assign: "PartitionResult" };
    s4 = { [J]: "UseFIPS" };
    t4 = { [J]: "UseDualStack" };
    u4 = {
      url: "https://sts.amazonaws.com",
      properties: { authSchemes: [{ name: e4, signingName: f4, signingRegion: g4 }] },
      headers: {}
    };
    v4 = {};
    ...
    A = { [J]: "PartitionResult" };
    B = { [H]: c4, [I]: [true, { [H]: l4, [I]: [A, "supportsDualStack"] }] };
    C = [{ [H]: "isSet", [I]: [o4] }];
    D = [x4];
    E = [y];
    _data4 = {
      version: "1.0",
      parameters: { Region: m4, UseDualStack: n4, UseFIPS: n4, Endpoint: m4, UseGlobalEndpoint: n4 },
      rules: [
        {
          conditions: [
            { [H]: c4, [I]: [{ [J]: "UseGlobalEndpoint" }, b4] },
            { [H]: "not", [I]: C },
            p4,
            r4,
            { [H]: c4, [I]: [s4, a4] },
              ...
              rules: [
                {
                  ...
                  rules: [
                    ...
                    { error: "FIPS and DualStack are enabled, but this partition does not support one or both", [G]: k4 }
                  ],
                  [G]: j4
                },
                {
                  ...
                  rules: [
                    ...
                    { error: "FIPS is enabled but this partition does not support FIPS", [G]: k4 }
                  ],
                  [G]: j4
                },
                {
                  ...
                  rules: [
                    ...
                    { error: "DualStack is enabled but this partition does not support DualStack", [G]: k4 }
                  ],
                  [G]: j4
                },
                w4,
        ...
        { error: "Invalid Configuration: Missing Region", [G]: k4 }
      ]
    };
    ruleSet4 = _data4;
  }
...
var init_runtimeConfig4 = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/runtimeConfig.js"() {
    ...
    import_middleware_retry7 = __toESM(require_dist_cjs37());
    ...
    import_util_retry4 = __toESM(require_dist_cjs28());
...
var init_STSClient = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/STSClient.js"() {
    ...
    import_middleware_user_agent4 = __toESM(require_dist_cjs29());
    import_config_resolver8 = __toESM(require_dist_cjs31());
    init_dist_es();
    init_schema();
    import_middleware_content_length4 = __toESM(require_dist_cjs32());
    import_middleware_endpoint7 = __toESM(require_dist_cjs36());
    import_middleware_retry8 = __toESM(require_dist_cjs37());
    ...
    STSClient = class extends import_smithy_client33.Client {
      ...
      constructor(...[configuration]) {
        ...
        const _config_6 = (0, import_middleware_endpoint7.resolveEndpointConfig)(_config_5);
...
var init_AssumeRoleCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleCommand.js"() {
    "use strict";
    import_middleware_endpoint8 = __toESM(require_dist_cjs36());
    import_smithy_client34 = __toESM(require_dist_cjs25());
    init_EndpointParameters4();
    init_schemas_04();
    AssumeRoleCommand = class extends import_smithy_client34.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o5) {
      return [(0, import_middleware_endpoint8.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())];
...
var init_AssumeRoleWithWebIdentityCommand = __esm({
  "node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/commands/AssumeRoleWithWebIdentityCommand.js"() {
    "use strict";
    import_middleware_endpoint9 = __toESM(require_dist_cjs36());
    import_smithy_client35 = __toESM(require_dist_cjs25());
    init_EndpointParameters4();
    init_schemas_04();
    AssumeRoleWithWebIdentityCommand = class extends import_smithy_client35.Command.classBuilder().ep(commonParams4).m(function(Command, cs, config, o5) {
...
var require_fromWebToken = __commonJS({
  "node_modules/@aws-sdk/credential-provider-web-identity/dist-cjs/fromWebToken.js"(exports2) {
    ...
    var __setModuleDefault2 = exports2 && exports2.__setModuleDefault || (Object.create ? function(o5, v5) {
      Object.defineProperty(o5, "default", { enumerable: true, value: v5 });
    } : function(o5, v5) {
      o5["default"] = v5;
    });
...
var require_dist_cjs51 = __commonJS({
  "node_modules/@aws-sdk/credential-provider-ini/dist-cjs/index.js"(exports2) {
    ...
    var resolveProcessCredentials = async (options, profile) => Promise.resolve().then(() => __toESM(require_dist_cjs49())).then(({ fromProcess }) => fromProcess({
      ...options,
      profile
    ...
    var resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.resolve().then(() => __toESM(require_dist_cjs50())).then(({ fromTokenFile }) => fromTokenFile({
...
`);
      ...
      async (awsIdentityProperties) => {
        ...
        const { fromIni } = await Promise.resolve().then(() => __toESM(require_dist_cjs51()));
        return fromIni(init)(awsIdentityProperties);
      },
      async (awsIdentityProperties) => {
        init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
        const { fromProcess } = await Promise.resolve().then(() => __toESM(require_dist_cjs49()));
        return fromProcess(init)(awsIdentityProperties);
      },
      async (awsIdentityProperties) => {
        init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
        const { fromTokenFile } = await Promise.resolve().then(() => __toESM(require_dist_cjs50()));
...
// node_modules/@aws-sdk/client-textract/dist-cjs/endpoint/ruleset.js
var require_ruleset = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/endpoint/ruleset.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    var q5 = [l5];
    var r5 = [{ [v5]: "Region" }];
    var _data5 = { version: "1.0", parameters: { Region: h5, UseDualStack: i5, UseFIPS: i5, Endpoint: h5 }, rules: [{ conditions: [{ [t5]: b5, [u5]: [j5] }], rules: [{ conditions: p5, error: "Invalid Configuration: FIPS and custom endpoint are not supported", type: d5 }, { conditions: q5, error: "Invalid Configuration: Dualstack and custom endpoint are not supported", type: d5 }, { endpoint: { url: j5, properties: m5, headers: m5 }, type: e5 }], type: f5 }, { conditions: [{ [t5]: b5, [u5]: r5 }], rules: [{ conditions: [{ [t5]: "aws.partition", [u5]: r5, assign: g5 }], rules: [{ conditions: [k5, l5], rules: [{ conditions: [{ [t5]: c5, [u5]: [a5, n5] }, o5], rules: [{ endpoint: { url: "https://textract-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }, { error: "FIPS and DualStack are enabled, but this partition does not support one or both", type: d5 }], type: f5 }, { conditions: p5, rules: [{ conditions: [{ [t5]: c5, [u5]: [n5, a5] }], rules: [{ endpoint: { url: "https://textract-fips.{Region}.{PartitionResult#dnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }, { error: "FIPS is enabled but this partition does not support FIPS", type: d5 }], type: f5 }, { conditions: q5, rules: [{ conditions: [o5], rules: [{ endpoint: { url: "https://textract.{Region}.{PartitionResult#dualStackDnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }, { error: "DualStack is enabled but this partition does not support DualStack", type: d5 }], type: f5 }, { endpoint: { url: "https://textract.{Region}.{PartitionResult#dnsSuffix}", properties: m5, headers: m5 }, type: e5 }], type: f5 }], type: f5 }, { error: "Invalid Configuration: Missing Region", type: d5 }] };
    exports2.ruleSet = _data5;
  }
});

// node_modules/@aws-sdk/client-textract/dist-cjs/endpoint/endpointResolver.js
var require_endpointResolver = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/endpoint/endpointResolver.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
// node_modules/@aws-sdk/client-textract/dist-cjs/models/TextractServiceException.js
var require_TextractServiceException = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/models/TextractServiceException.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.TextractServiceException = exports2.__ServiceException = void 0;
    var smithy_client_1 = require_dist_cjs25();
    Object.defineProperty(exports2, "__ServiceException", { enumerable: true, get: function() {
      return smithy_client_1.ServiceException;
    } });
    var TextractServiceException = class _TextractServiceException extends smithy_client_1.ServiceException {
      constructor(options) {
        super(options);
        Object.setPrototypeOf(this, _TextractServiceException.prototype);
      }
    };
    exports2.TextractServiceException = TextractServiceException;
  }
});

// node_modules/@aws-sdk/client-textract/dist-cjs/models/errors.js
var require_errors = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/models/errors.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.InvalidJobIdException = exports2.ResourceNotFoundException = exports2.InvalidKMSKeyException = exports2.ValidationException = exports2.ServiceQuotaExceededException = exports2.LimitExceededException = exports2.IdempotentParameterMismatchException = exports2.ConflictException = exports2.UnsupportedDocumentException = exports2.ThrottlingException = exports2.ProvisionedThroughputExceededException = exports2.InvalidS3ObjectException = exports2.InvalidParameterException = exports2.InternalServerError = exports2.HumanLoopQuotaExceededException = exports2.DocumentTooLargeException = exports2.BadDocumentException = exports2.AccessDeniedException = void 0;
    var TextractServiceException_1 = require_TextractServiceException();
    var AccessDeniedException3 = class _AccessDeniedException extends TextractServiceException_1.TextractServiceException {
      name = "AccessDeniedException";
      $fault = "client";
      Message;
      Code;
    ...
    var BadDocumentException = class _BadDocumentException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.BadDocumentException = BadDocumentException;
    var DocumentTooLargeException = class _DocumentTooLargeException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.DocumentTooLargeException = DocumentTooLargeException;
    var HumanLoopQuotaExceededException = class _HumanLoopQuotaExceededException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.HumanLoopQuotaExceededException = HumanLoopQuotaExceededException;
    var InternalServerError = class _InternalServerError extends TextractServiceException_1.TextractServiceException {
    ...
    var InvalidParameterException = class _InvalidParameterException extends TextractServiceException_1.TextractServiceException {
    ...
    var InvalidS3ObjectException = class _InvalidS3ObjectException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.InvalidS3ObjectException = InvalidS3ObjectException;
    var ProvisionedThroughputExceededException = class _ProvisionedThroughputExceededException extends TextractServiceException_1.TextractServiceException {
    ...
    var ThrottlingException = class _ThrottlingException extends TextractServiceException_1.TextractServiceException {
    ...
    var UnsupportedDocumentException = class _UnsupportedDocumentException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.UnsupportedDocumentException = UnsupportedDocumentException;
    var ConflictException = class _ConflictException extends TextractServiceException_1.TextractServiceException {
    ...
    var IdempotentParameterMismatchException = class _IdempotentParameterMismatchException extends TextractServiceException_1.TextractServiceException {
    ...
    var LimitExceededException = class _LimitExceededException extends TextractServiceException_1.TextractServiceException {
    ...
    var ServiceQuotaExceededException = class _ServiceQuotaExceededException extends TextractServiceException_1.TextractServiceException {
    ...
    var ValidationException2 = class _ValidationException extends TextractServiceException_1.TextractServiceException {
      name = "ValidationException";
      $fault = "client";
      Message;
      Code;
    ...
    var InvalidKMSKeyException = class _InvalidKMSKeyException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.InvalidKMSKeyException = InvalidKMSKeyException;
    var ResourceNotFoundException2 = class _ResourceNotFoundException extends TextractServiceException_1.TextractServiceException {
      name = "ResourceNotFoundException";
      $fault = "client";
      Message;
      Code;
    ...
    var InvalidJobIdException = class _InvalidJobIdException extends TextractServiceException_1.TextractServiceException {
    ...
    exports2.InvalidJobIdException = InvalidJobIdException;
  }
});

// node_modules/@aws-sdk/client-textract/dist-cjs/schemas/schemas_0.js
var require_schemas_0 = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/schemas/schemas_0.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.DocumentMetadata$ = exports2.DocumentLocation$ = exports2.DocumentGroup$ = exports2.Document$ = exports2.DetectedSignature$ = exports2.DetectDocumentTextResponse$ = exports2.DetectDocumentTextRequest$ = exports2.DeleteAdapterVersionResponse$ = exports2.DeleteAdapterVersionRequest$ = exports2.DeleteAdapterResponse$ = exports2.DeleteAdapterRequest$ = exports2.CreateAdapterVersionResponse$ = exports2.CreateAdapterVersionRequest$ = exports2.CreateAdapterResponse$ = exports2.CreateAdapterRequest$ = exports2.BoundingBox$ = exports2.Block$ = exports2.AnalyzeIDResponse$ = exports2.AnalyzeIDRequest$ = exports2.AnalyzeIDDetections$ = exports2.AnalyzeExpenseResponse$ = exports2.AnalyzeExpenseRequest$ = exports2.AnalyzeDocumentResponse$ = exports2.AnalyzeDocumentRequest$ = exports2.AdapterVersionOverview$ = exports2.AdapterVersionEvaluationMetric$ = exports2.AdapterVersionDatasetConfig$ = exports2.AdaptersConfig$ = exports2.AdapterOverview$ = exports2.Adapter$ = exports2.errorTypeRegistries = exports2.ValidationException$ = exports2.UnsupportedDocumentException$ = exports2.ThrottlingException$ = exports2.ServiceQuotaExceededException$ = exports2.ResourceNotFoundException$ = exports2.ProvisionedThroughputExceededException$ = exports2.LimitExceededException$ = exports2.InvalidS3ObjectException$ = exports2.InvalidParameterException$ = exports2.InvalidKMSKeyException$ = exports2.InvalidJobIdException$ = exports2.InternalServerError$ = exports2.IdempotentParameterMismatchException$ = exports2.HumanLoopQuotaExceededException$ = exports2.DocumentTooLargeException$ = exports2.ConflictException$ = exports2.BadDocumentException$ = exports2.AccessDeniedException$ = exports2.TextractServiceException$ = void 0;
    exports2.Relationship$ = exports2.Query$ = exports2.QueriesConfig$ = exports2.Prediction$ = exports2.Point$ = exports2.PageClassification$ = exports2.OutputConfig$ = exports2.NotificationChannel$ = exports2.NormalizedValue$ = exports2.ListTagsForResourceResponse$ = exports2.ListTagsForResourceRequest$ = exports2.ListAdapterVersionsResponse$ = exports2.ListAdapterVersionsRequest$ = exports2.ListAdaptersResponse$ = exports2.ListAdaptersRequest$ = exports2.LineItemGroup$ = exports2.LineItemFields$ = exports2.LendingSummary$ = exports2.LendingResult$ = exports2.LendingField$ = exports2.LendingDocument$ = exports2.LendingDetection$ = exports2.IdentityDocumentField$ = exports2.IdentityDocument$ = exports2.HumanLoopDataAttributes$ = exports2.HumanLoopConfig$ = exports2.HumanLoopActivationOutput$ = exports2.GetLendingAnalysisSummaryResponse$ = exports2.GetLendingAnalysisSummaryRequest$ = exports2.GetLendingAnalysisResponse$ = exports2.GetLendingAnalysisRequest$ = exports2.GetExpenseAnalysisResponse$ = exports2.GetExpenseAnalysisRequest$ = exports2.GetDocumentTextDetectionResponse$ = exports2.GetDocumentTextDetectionRequest$ = exports2.GetDocumentAnalysisResponse$ = exports2.GetDocumentAnalysisRequest$ = exports2.GetAdapterVersionResponse$ = exports2.GetAdapterVersionRequest$ = exports2.GetAdapterResponse$ = exports2.GetAdapterRequest$ = exports2.Geometry$ = exports2.Extraction$ = exports2.ExpenseType$ = exports2.ExpenseGroupProperty$ = exports2.ExpenseField$ = exports2.ExpenseDocument$ = exports2.ExpenseDetection$ = exports2.ExpenseCurrency$ = exports2.EvaluationMetric$ = void 0;
    exports2.UpdateAdapter$ = exports2.UntagResource$ = exports2.TagResource$ = exports2.StartLendingAnalysis$ = exports2.StartExpenseAnalysis$ = exports2.StartDocumentTextDetection$ = exports2.StartDocumentAnalysis$ = exports2.ListTagsForResource$ = exports2.ListAdapterVersions$ = exports2.ListAdapters$ = exports2.GetLendingAnalysisSummary$ = exports2.GetLendingAnalysis$ = exports2.GetExpenseAnalysis$ = exports2.GetDocumentTextDetection$ = exports2.GetDocumentAnalysis$ = exports2.GetAdapterVersion$ = exports2.GetAdapter$ = exports2.DetectDocumentText$ = exports2.DeleteAdapterVersion$ = exports2.DeleteAdapter$ = exports2.CreateAdapterVersion$ = exports2.CreateAdapter$ = exports2.AnalyzeID$ = exports2.AnalyzeExpense$ = exports2.AnalyzeDocument$ = exports2.Warning$ = exports2.UpdateAdapterResponse$ = exports2.UpdateAdapterRequest$ = exports2.UntagResourceResponse$ = exports2.UntagResourceRequest$ = exports2.UndetectedSignature$ = exports2.TagResourceResponse$ = exports2.TagResourceRequest$ = exports2.StartLendingAnalysisResponse$ = exports2.StartLendingAnalysisRequest$ = exports2.StartExpenseAnalysisResponse$ = exports2.StartExpenseAnalysisRequest$ = exports2.StartDocumentTextDetectionResponse$ = exports2.StartDocumentTextDetectionRequest$ = exports2.StartDocumentAnalysisResponse$ = exports2.StartDocumentAnalysisRequest$ = exports2.SplitDocument$ = exports2.SignatureDetection$ = exports2.S3Object$ = void 0;
    var _A2 = "Adapter";
    var _AC = "AdaptersConfig";
    var _ACT = "AfterCreationTime";
    var _AD = "AnalyzeDocument";
    var _ADE3 = "AccessDeniedException";
    var _ADMV = "AnalyzeDocumentModelVersion";
    var _ADR = "AnalyzeDocumentRequest";
    var _ADRn = "AnalyzeDocumentResponse";
    var _AE = "AnalyzeExpense";
    var _AEMV = "AnalyzeExpenseModelVersion";
    var _AER = "AnalyzeExpenseRequest";
    var _AERn = "AnalyzeExpenseResponse";
    var _AI = "AdapterId";
    var _AID = "AnalyzeID";
    var _AIDD = "AnalyzeIDDetections";
    var _AIDMV = "AnalyzeIDModelVersion";
    var _AIDR = "AnalyzeIDRequest";
    var _AIDRn = "AnalyzeIDResponse";
    var _AL = "AdapterList";
    var _ALMV = "AnalyzeLendingModelVersion";
    var _AN = "AdapterName";
    var _AO = "AdapterOverview";
    var _AU = "AutoUpdate";
    var _AV = "AdapterVersion";
    var _AVDC = "AdapterVersionDatasetConfig";
    var _AVEM = "AdapterVersionEvaluationMetric";
    var _AVEMd = "AdapterVersionEvaluationMetrics";
    var _AVL = "AdapterVersionList";
    var _AVO = "AdapterVersionOverview";
    var _AVd = "AdapterVersions";
    var _Ad = "Adapters";
    var _Al = "Alias";
    var _B = "Baseline";
    var _BB = "BoundingBox";
    var _BCT = "BeforeCreationTime";
    var _BDE = "BadDocumentException";
    var _BL = "BlockList";
    var _BT = "BlockType";
    var _Bl = "Blocks";
    var _Blo = "Block";
    ...
    var _By = "Bytes";
    var _C2 = "Code";
    var _CA2 = "CreateAdapter";
    var _CAR = "CreateAdapterRequest";
    var _CARr = "CreateAdapterResponse";
    var _CAV = "CreateAdapterVersion";
    var _CAVR = "CreateAdapterVersionRequest";
    var _CAVRr = "CreateAdapterVersionResponse";
    var _CC = "ContentClassifiers";
    ...
    var _Cu = "Currency";
    var _D = "Document";
    var _DA = "DataAttributes";
    var _DAR = "DeleteAdapterRequest";
    var _DARe = "DeleteAdapterResponse";
    var _DAV = "DeleteAdapterVersion";
    var _DAVR = "DeleteAdapterVersionRequest";
    var _DAVRe = "DeleteAdapterVersionResponse";
    var _DAe = "DeleteAdapter";
    var _DC = "DatasetConfig";
    var _DDT = "DetectDocumentText";
    var _DDTMV = "DetectDocumentTextModelVersion";
    var _DDTR = "DetectDocumentTextRequest";
    var _DDTRe = "DetectDocumentTextResponse";
    var _DG = "DocumentGroup";
    var _DGL = "DocumentGroupList";
    var _DGo = "DocumentGroups";
    var _DI = "DocumentIndex";
    var _DL = "DocumentLocation";
    var _DM = "DocumentMetadata";
    var _DP = "DocumentPages";
    var _DS2 = "DetectedSignature";
    var _DSL = "DetectedSignatureList";
    var _DSe = "DetectedSignatures";
    var _DTLE = "DocumentTooLargeException";
    var _De = "Description";
    var _E2 = "Extraction";
    var _EC = "ExpenseCurrency";
    var _ECr = "ErrorCode";
    var _ED = "ExpenseDocuments";
    var _EDL = "ExpenseDocumentList";
    var _EDx = "ExpenseDetection";
    var _EDxp = "ExpenseDocument";
    var _EF = "ExpenseField";
    var _EFL = "ExpenseFieldList";
    var _EGP = "ExpenseGroupProperty";
    var _EGPL = "ExpenseGroupPropertyList";
    var _EI2 = "ExpenseIndex";
    var _EL = "ExtractionList";
    var _EM = "EvaluationMetric";
    var _EMv = "EvaluationMetrics";
    var _ET = "EntityTypes";
    var _ETx = "ExpenseType";
    var _Ex = "Extractions";
    var _FDA = "FlowDefinitionArn";
    var _FS = "F1Score";
    var _FT = "FeatureTypes";
    var _FTe = "FeatureType";
    var _G = "Geometry";
    var _GA = "GetAdapter";
    var _GAR = "GetAdapterRequest";
    var _GARe = "GetAdapterResponse";
    var _GAV = "GetAdapterVersion";
    var _GAVR = "GetAdapterVersionRequest";
    var _GAVRe = "GetAdapterVersionResponse";
    var _GDA = "GetDocumentAnalysis";
    var _GDAR = "GetDocumentAnalysisRequest";
    var _GDARe = "GetDocumentAnalysisResponse";
    var _GDTD = "GetDocumentTextDetection";
    var _GDTDR = "GetDocumentTextDetectionRequest";
    var _GDTDRe = "GetDocumentTextDetectionResponse";
    var _GEA = "GetExpenseAnalysis";
    var _GEAR = "GetExpenseAnalysisRequest";
    var _GEARe = "GetExpenseAnalysisResponse";
    var _GLA = "GetLendingAnalysis";
    var _GLAR = "GetLendingAnalysisRequest";
    var _GLARe = "GetLendingAnalysisResponse";
    var _GLAS = "GetLendingAnalysisSummary";
    var _GLASR = "GetLendingAnalysisSummaryRequest";
    var _GLASRe = "GetLendingAnalysisSummaryResponse";
    var _GP = "GroupProperties";
    var _H = "Height";
    var _HLA = "HumanLoopArn";
    var _HLACER = "HumanLoopActivationConditionsEvaluationResults";
    var _HLAO = "HumanLoopActivationOutput";
    var _HLAR = "HumanLoopActivationReasons";
    var _HLC = "HumanLoopConfig";
    var _HLDA = "HumanLoopDataAttributes";
    var _HLN = "HumanLoopName";
    var _HLQEE = "HumanLoopQuotaExceededException";
    var _I = "Id";
    var _ID = "IdentityDocuments";
    var _IDF = "IdentityDocumentFields";
    var _IDFL = "IdentityDocumentFieldList";
    var _IDFd = "IdentityDocumentField";
    var _IDL = "IdentityDocumentList";
    var _IDd = "IdentityDocument";
    var _IJIE = "InvalidJobIdException";
    var _IKMSKE = "InvalidKMSKeyException";
    var _IPE = "InvalidParameterException";
    var _IPME = "IdempotentParameterMismatchException";
    var _ISE3 = "InternalServerError";
    var _ISOE = "InvalidS3ObjectException";
    var _Id = "Ids";
    var _In = "Index";
    var _JI = "JobId";
    var _JS = "JobStatus";
    var _JT = "JobTag";
    var _KD = "KeyDetection";
    var _KMSKI = "KMSKeyId";
    var _L = "Left";
    var _LA = "ListAdapters";
    var _LAR = "ListAdaptersRequest";
    var _LARi = "ListAdaptersResponse";
    var _LAV = "ListAdapterVersions";
    var _LAVR = "ListAdapterVersionsRequest";
    var _LAVRi = "ListAdapterVersionsResponse";
    var _LD = "LabelDetection";
    var _LDL = "LendingDetectionList";
    var _LDe = "LendingDocument";
    var _LDen = "LendingDetection";
    var _LEE = "LimitExceededException";
    var _LF = "LendingFields";
    var _LFL = "LendingFieldList";
    var _LFe = "LendingField";
    var _LI = "LineItems";
    var _LIEF = "LineItemExpenseFields";
    var _LIF = "LineItemFields";
    var _LIG = "LineItemGroups";
    var _LIGI = "LineItemGroupIndex";
    var _LIGL = "LineItemGroupList";
    var _LIGi = "LineItemGroup";
    var _LIL = "LineItemList";
    var _LR = "LendingResult";
    var _LRL = "LendingResultList";
    var _LS = "LendingSummary";
    var _LTFR = "ListTagsForResource";
    var _LTFRR = "ListTagsForResourceRequest";
    var _LTFRRi = "ListTagsForResourceResponse";
    var _M = "Message";
    var _MR = "MaxResults";
    var _MSO = "ManifestS3Object";
    var _N = "Name";
    var _NC = "NotificationChannel";
    var _NT = "NextToken";
    var _NV = "NormalizedValue";
    var _OC = "OutputConfig";
    var _P2 = "Pages";
    var _PC2 = "PageClassification";
    var _PL = "PredictionList";
    var _PN = "PageNumber";
    var _PT = "PageType";
    ...
    var _Q = "Query";
    var _QC = "QuotaCode";
    var _QCu = "QueriesConfig";
    var _Qu = "Queries";
    var _R = "Relationships";
    var _RA2 = "RotationAngle";
    var _RARN = "ResourceARN";
    var _RAo = "RoleArn";
    var _RI = "RowIndex";
    var _RL = "RelationshipList";
    var _RNFE2 = "ResourceNotFoundException";
    var _RS = "RowSpan";
    var _RT3 = "ResourceType";
    var _Re = "Recall";
    var _Rel = "Relationship";
    var _Res = "Results";
    var _S = "Status";
    var _SB = "S3Bucket";
    var _SC = "ServiceCode";
    var _SD = "SplitDocuments";
    var _SDA = "StartDocumentAnalysis";
    var _SDAR = "StartDocumentAnalysisRequest";
    var _SDARt = "StartDocumentAnalysisResponse";
    var _SDL = "SignatureDetectionList";
    var _SDLp = "SplitDocumentList";
    var _SDTD = "StartDocumentTextDetection";
    var _SDTDR = "StartDocumentTextDetectionRequest";
    var _SDTDRt = "StartDocumentTextDetectionResponse";
    var _SDi = "SignatureDetections";
    var _SDig = "SignatureDetection";
    var _SDp = "SplitDocument";
    var _SEA = "StartExpenseAnalysis";
    var _SEAR = "StartExpenseAnalysisRequest";
    var _SEARt = "StartExpenseAnalysisResponse";
    var _SF = "SummaryFields";
    var _SJHLACER = "SynthesizedJsonHumanLoopActivationConditionsEvaluationResults";
    var _SLA = "StartLendingAnalysis";
    var _SLAR = "StartLendingAnalysisRequest";
    var _SLARt = "StartLendingAnalysisResponse";
    var _SM = "StatusMessage";
    var _SNSTA = "SNSTopicArn";
    var _SO = "S3Object";
    var _SP = "S3Prefix";
    var _SQEE = "ServiceQuotaExceededException";
    var _SS = "SelectionStatus";
    var _Su = "Summary";
    var _T2 = "Text";
    ...
    var _Ty = "Type";
    var _Typ = "Types";
    var _UA = "UpdateAdapter";
    var _UAR = "UpdateAdapterRequest";
    var _UARp = "UpdateAdapterResponse";
    var _UDE = "UnsupportedDocumentException";
    var _UDT = "UndetectedDocumentTypes";
    var _UR = "UntagResource";
    var _URR = "UntagResourceRequest";
    var _URRn = "UntagResourceResponse";
    var _US = "UndetectedSignatures";
    var _USL = "UndetectedSignatureList";
    var _USn = "UndetectedSignature";
    var _V2 = "Version";
    var _VD = "ValueDetection";
    var _VDa = "ValueDetections";
    ...
    var _X = "X";
    var _Y = "Y";
    var _a2 = "application/json";
    var _c5 = "client";
    var _e5 = "error";
    var _hE5 = "httpError";
    var _mT = "mediaType";
    var _s5 = "smithy.ts.sdk.synthetic.com.amazonaws.textract";
    var _se3 = "server";
    var n05 = "com.amazonaws.textract";
    var schema_1 = (init_schema(), __toCommonJS(schema_exports));
    var errors_1 = require_errors();
    var TextractServiceException_1 = require_TextractServiceException();
    var _s_registry5 = schema_1.TypeRegistry.for(_s5);
    exports2.TextractServiceException$ = [-3, _s5, "TextractServiceException", 0, [], []];
    _s_registry5.registerError(exports2.TextractServiceException$, TextractServiceException_1.TextractServiceException);
    ...
    n0_registry5.registerError(exports2.BadDocumentException$, errors_1.BadDocumentException);
    ...
    exports2.DocumentTooLargeException$ = [
      -3,
      n05,
      _DTLE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports2.DocumentTooLargeException$, errors_1.DocumentTooLargeException);
    exports2.HumanLoopQuotaExceededException$ = [
      -3,
      n05,
      _HLQEE,
      { [_e5]: _c5, [_hE5]: 402 },
    ...
    n0_registry5.registerError(exports2.HumanLoopQuotaExceededException$, errors_1.HumanLoopQuotaExceededException);
    ...
    exports2.InvalidJobIdException$ = [
      -3,
      n05,
      _IJIE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports2.InvalidJobIdException$, errors_1.InvalidJobIdException);
    exports2.InvalidKMSKeyException$ = [
      -3,
      n05,
      _IKMSKE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports2.InvalidKMSKeyException$, errors_1.InvalidKMSKeyException);
    ...
    n0_registry5.registerError(exports2.InvalidS3ObjectException$, errors_1.InvalidS3ObjectException);
    exports2.LimitExceededException$ = [
      -3,
      n05,
      _LEE,
    ...
    exports2.UnsupportedDocumentException$ = [
      -3,
      n05,
      _UDE,
      { [_e5]: _c5 },
    ...
    n0_registry5.registerError(exports2.UnsupportedDocumentException$, errors_1.UnsupportedDocumentException);
    ...
    var SynthesizedJsonHumanLoopActivationConditionsEvaluationResults = [0, n05, _SJHLACER, { [_mT]: _a2 }, 0];
    exports2.Adapter$ = [
      3,
      n05,
      _A2,
    ...
    exports2.AdapterVersionDatasetConfig$ = [
      3,
      n05,
      _AVDC,
      0,
    ...
    exports2.AdapterVersionEvaluationMetric$ = [
      3,
      n05,
      _AVEM,
      0,
      [_B, _AV, _FTe],
      [() => exports2.EvaluationMetric$, () => exports2.EvaluationMetric$, 0]
    ];
    exports2.AdapterVersionOverview$ = [
      3,
      n05,
      _AVO,
      0,
      [_AI, _AV, _CT2, _FT, _S, _SM],
      [0, 0, 4, 64 | 0, 0, 0]
    ];
    exports2.AnalyzeDocumentRequest$ = [
      3,
      n05,
      _ADR,
      0,
      [_D, _FT, _HLC, _QCu, _AC],
      [() => exports2.Document$, 64 | 0, () => exports2.HumanLoopConfig$, () => exports2.QueriesConfig$, () => exports2.AdaptersConfig$],
      2
    ];
    exports2.AnalyzeDocumentResponse$ = [
      3,
      n05,
      _ADRn,
      0,
      [_DM, _Bl, _HLAO, _ADMV],
      [() => exports2.DocumentMetadata$, () => BlockList, [() => exports2.HumanLoopActivationOutput$, 0], 0]
    ];
    exports2.AnalyzeExpenseRequest$ = [
      3,
      n05,
      _AER,
      0,
    ...
    exports2.AnalyzeExpenseResponse$ = [
      3,
      n05,
      _AERn,
      0,
      [_DM, _ED],
      [() => exports2.DocumentMetadata$, () => ExpenseDocumentList]
    ];
    exports2.AnalyzeIDDetections$ = [
      3,
      n05,
      _AIDD,
      0,
      [_T2, _NV, _Co],
      [0, () => exports2.NormalizedValue$, 1],
      1
    ];
    exports2.AnalyzeIDRequest$ = [
      3,
      n05,
      _AIDR,
      0,
    ...
    exports2.AnalyzeIDResponse$ = [
      3,
      n05,
      _AIDRn,
      0,
      [_ID, _DM, _AIDMV],
      [() => IdentityDocumentList, () => exports2.DocumentMetadata$, 0]
    ];
    exports2.Block$ = [
      3,
      n05,
      _Blo,
      0,
      [_BT, _Co, _T2, _TT, _RI, _CI, _RS, _CS2, _G, _I, _R, _ET, _SS, _Pa, _Q],
      [0, 1, 0, 0, 1, 1, 1, 1, () => exports2.Geometry$, 0, () => RelationshipList, 64 | 0, 0, 1, () => exports2.Query$]
    ];
    exports2.BoundingBox$ = [
      3,
      n05,
      _BB,
      0,
    ...
    exports2.CreateAdapterRequest$ = [
      3,
      n05,
      _CAR,
      0,
      [_AN, _FT, _CRT, _De, _AU, _Ta2],
      [0, 64 | 0, [0, 4], 0, 0, 128 | 0],
      2
    ];
    exports2.CreateAdapterResponse$ = [
      3,
      n05,
      _CARr,
      0,
    ...
    exports2.CreateAdapterVersionRequest$ = [
      3,
      n05,
      _CAVR,
      0,
      [_AI, _DC, _OC, _CRT, _KMSKI, _Ta2],
      [0, () => exports2.AdapterVersionDatasetConfig$, () => exports2.OutputConfig$, [0, 4], 0, 128 | 0],
      3
    ];
    exports2.CreateAdapterVersionResponse$ = [
      3,
      n05,
      _CAVRr,
      0,
    ...
    exports2.DeleteAdapterResponse$ = [
      3,
      n05,
      _DARe,
      0,
    ...
    exports2.DeleteAdapterVersionRequest$ = [
      3,
      n05,
      _DAVR,
      0,
    ...
    exports2.DeleteAdapterVersionResponse$ = [
      3,
      n05,
      _DAVRe,
      0,
    ...
    exports2.DetectDocumentTextRequest$ = [
      3,
      n05,
      _DDTR,
      0,
    ...
    exports2.DetectDocumentTextResponse$ = [
      3,
      n05,
      _DDTRe,
      0,
      [_DM, _Bl, _DDTMV],
      [() => exports2.DocumentMetadata$, () => BlockList, 0]
    ];
    exports2.DetectedSignature$ = [
      3,
      n05,
      _DS2,
      0,
    ...
    exports2.Document$ = [
      ...
      0,
      [_By, _SO],
      [21, () => exports2.S3Object$]
    ];
    exports2.DocumentGroup$ = [
      3,
      n05,
      _DG,
      0,
    ...
    exports2.ExpenseDetection$ = [
      3,
      n05,
      _EDx,
      0,
      [_T2, _G, _Co],
      [0, () => exports2.Geometry$, 1]
    ];
    exports2.ExpenseDocument$ = [
      3,
      n05,
      _EDxp,
      0,
    ...
    exports2.ExpenseField$ = [
      3,
      n05,
      _EF,
      0,
      [_Ty, _LD, _VD, _PN, _Cu, _GP],
      [() => exports2.ExpenseType$, () => exports2.ExpenseDetection$, () => exports2.ExpenseDetection$, 1, () => exports2.ExpenseCurrency$, () => ExpenseGroupPropertyList]
    ];
    exports2.ExpenseGroupProperty$ = [
      3,
      n05,
      _EGP,
      0,
    ...
    exports2.Extraction$ = [
      ...
      0,
      [_LDe, _EDxp, _IDd],
      [() => exports2.LendingDocument$, () => exports2.ExpenseDocument$, () => exports2.IdentityDocument$]
    ];
    exports2.Geometry$ = [
      3,
      n05,
      ...
      0,
      [_BB, _Po, _RA2],
      [() => exports2.BoundingBox$, () => Polygon, 1]
    ];
    exports2.GetAdapterRequest$ = [
      3,
      n05,
      _GAR,
      0,
    ...
    exports2.GetAdapterResponse$ = [
      3,
      n05,
      _GARe,
      0,
      [_AI, _AN, _CT2, _De, _FT, _AU, _Ta2],
      [0, 0, 4, 0, 64 | 0, 0, 128 | 0]
    ];
    exports2.GetAdapterVersionRequest$ = [
      3,
      n05,
      _GAVR,
      0,
    ...
    exports2.GetAdapterVersionResponse$ = [
      3,
      n05,
      _GAVRe,
      0,
      [_AI, _AV, _CT2, _FT, _S, _SM, _DC, _KMSKI, _OC, _EMv, _Ta2],
      [0, 0, 4, 64 | 0, 0, 0, () => exports2.AdapterVersionDatasetConfig$, 0, () => exports2.OutputConfig$, () => AdapterVersionEvaluationMetrics, 128 | 0]
    ];
    exports2.GetDocumentAnalysisRequest$ = [
      3,
      n05,
    ...
    exports2.GetDocumentAnalysisResponse$ = [
      3,
      n05,
      _GDARe,
      0,
      [_DM, _JS, _NT, _Bl, _Wa, _SM, _ADMV],
      [() => exports2.DocumentMetadata$, 0, 0, () => BlockList, () => Warnings, 0, 0]
    ];
    exports2.GetDocumentTextDetectionRequest$ = [
      3,
      n05,
      _GDTDR,
      0,
    ...
    exports2.GetDocumentTextDetectionResponse$ = [
      3,
      n05,
      _GDTDRe,
      0,
    ...
    exports2.GetExpenseAnalysisRequest$ = [
      3,
      n05,
      _GEAR,
      0,
    ...
    exports2.GetExpenseAnalysisResponse$ = [
      3,
      n05,
      _GEARe,
      0,
      [_DM, _JS, _NT, _ED, _Wa, _SM, _AEMV],
      [() => exports2.DocumentMetadata$, 0, 0, () => ExpenseDocumentList, () => Warnings, 0, 0]
    ];
    exports2.GetLendingAnalysisRequest$ = [
      3,
      n05,
      _GLAR,
      0,
    ...
    exports2.GetLendingAnalysisResponse$ = [
      3,
      n05,
      _GLARe,
      0,
      [_DM, _JS, _NT, _Res, _Wa, _SM, _ALMV],
      [() => exports2.DocumentMetadata$, 0, 0, () => LendingResultList, () => Warnings, 0, 0]
    ];
    exports2.GetLendingAnalysisSummaryRequest$ = [
      3,
      n05,
      _GLASR,
      0,
    ...
    exports2.GetLendingAnalysisSummaryResponse$ = [
      3,
      n05,
      _GLASRe,
      0,
      [_DM, _JS, _Su, _Wa, _SM, _ALMV],
      [() => exports2.DocumentMetadata$, 0, () => exports2.LendingSummary$, () => Warnings, 0, 0]
    ];
    exports2.HumanLoopActivationOutput$ = [
      3,
      n05,
      _HLAO,
      0,
    ...
    exports2.HumanLoopConfig$ = [
      3,
      n05,
      _HLC,
      0,
      [_HLN, _FDA, _DA],
      [0, 0, () => exports2.HumanLoopDataAttributes$],
      2
    ];
    exports2.HumanLoopDataAttributes$ = [
      3,
      n05,
      _HLDA,
      0,
    ...
    exports2.IdentityDocumentField$ = [
      3,
      n05,
      _IDFd,
      0,
      [_Ty, _VD],
      [() => exports2.AnalyzeIDDetections$, () => exports2.AnalyzeIDDetections$]
    ];
    exports2.LendingDetection$ = [
      3,
      n05,
      _LDen,
      0,
      [_T2, _SS, _G, _Co],
      [0, 0, () => exports2.Geometry$, 1]
    ];
    exports2.LendingDocument$ = [
      3,
      n05,
      _LDe,
      0,
    ...
    exports2.LendingField$ = [
      3,
      n05,
      _LFe,
      0,
      [_Ty, _KD, _VDa],
      [0, () => exports2.LendingDetection$, () => LendingDetectionList]
    ];
    exports2.LendingResult$ = [
      3,
      n05,
      _LR,
      0,
      [_Pa, _PC2, _Ex],
      [1, () => exports2.PageClassification$, () => ExtractionList]
    ];
    exports2.LendingSummary$ = [
      3,
      n05,
      _LS,
      0,
    ...
    exports2.ListAdapterVersionsRequest$ = [
      3,
      n05,
      _LAVR,
      0,
    ...
    exports2.ListAdapterVersionsResponse$ = [
      3,
      n05,
      _LAVRi,
      0,
    ...
    exports2.StartDocumentAnalysisRequest$ = [
      3,
      n05,
      _SDAR,
      0,
      [_DL, _FT, _CRT, _JT, _NC, _OC, _KMSKI, _QCu, _AC],
      [() => exports2.DocumentLocation$, 64 | 0, 0, 0, () => exports2.NotificationChannel$, () => exports2.OutputConfig$, 0, () => exports2.QueriesConfig$, () => exports2.AdaptersConfig$],
      2
    ];
    exports2.StartDocumentAnalysisResponse$ = [
      3,
      n05,
      _SDARt,
      0,
    ...
    exports2.StartDocumentTextDetectionRequest$ = [
      3,
      n05,
      _SDTDR,
      0,
      [_DL, _CRT, _JT, _NC, _OC, _KMSKI],
      [() => exports2.DocumentLocation$, 0, 0, () => exports2.NotificationChannel$, () => exports2.OutputConfig$, 0],
      1
    ];
    exports2.StartDocumentTextDetectionResponse$ = [
      3,
      n05,
      _SDTDRt,
      0,
    ...
    exports2.StartExpenseAnalysisRequest$ = [
      3,
      n05,
      _SEAR,
      0,
    ...
    exports2.StartExpenseAnalysisResponse$ = [
      3,
      n05,
      _SEARt,
      0,
    ...
    exports2.StartLendingAnalysisRequest$ = [
      3,
      n05,
      _SLAR,
      0,
    ...
    exports2.StartLendingAnalysisResponse$ = [
      3,
      n05,
      _SLARt,
      0,
    ...
    exports2.UpdateAdapterResponse$ = [
      3,
      n05,
      _UARp,
      0,
      [_AI, _AN, _CT2, _De, _FT, _AU],
      [0, 0, 4, 0, 64 | 0, 0]
    ];
    exports2.Warning$ = [
      3,
    ...
    var AdapterVersionEvaluationMetrics = [
      1,
      n05,
      _AVEMd,
      0,
    ...
    exports2.GetDocumentTextDetection$ = [
      9,
      n05,
      _GDTD,
      0,
    ...
    exports2.GetLendingAnalysisSummary$ = [
      9,
      n05,
      _GLAS,
      0,
    ...
    exports2.StartDocumentAnalysis$ = [
      9,
      n05,
      _SDA,
      0,
    ...
    exports2.StartDocumentTextDetection$ = [
      9,
      n05,
      _SDTD,
      0,
...
// node_modules/@aws-sdk/client-textract/dist-cjs/runtimeConfig.shared.js
var require_runtimeConfig_shared = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/runtimeConfig.shared.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    var getRuntimeConfig9 = (config) => {
      return {
        ...
        extensions: config?.extensions ?? [],
        httpAuthSchemeProvider: config?.httpAuthSchemeProvider ?? httpAuthSchemeProvider_1.defaultTextractHttpAuthSchemeProvider,
        httpAuthSchemes: config?.httpAuthSchemes ?? [
          {
            schemeId: "aws.auth#sigv4",
            identityProvider: (ipc) => ipc.getIdentityProvider("aws.auth#sigv4"),
...
// node_modules/@aws-sdk/client-textract/dist-cjs/runtimeConfig.js
var require_runtimeConfig = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/runtimeConfig.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.getRuntimeConfig = void 0;
    var tslib_1 = (init_tslib_es6(), __toCommonJS(tslib_es6_exports));
...
// node_modules/@aws-sdk/client-textract/dist-cjs/index.js
var require_dist_cjs53 = __commonJS({
  "node_modules/@aws-sdk/client-textract/dist-cjs/index.js"(exports2) {
    "use strict";
    ...
    var TextractServiceException = require_TextractServiceException();
    ...
    var TextractClient2 = class extends smithyClient.Client {
      config;
      constructor(...[configuration]) {
    ...
    var AnalyzeDocumentCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "AnalyzeDocument", {}).n("TextractClient", "AnalyzeDocumentCommand").sc(schemas_0.AnalyzeDocument$).build() {
    };
    var AnalyzeExpenseCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "AnalyzeExpense", {}).n("TextractClient", "AnalyzeExpenseCommand").sc(schemas_0.AnalyzeExpense$).build() {
    };
    var AnalyzeIDCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "AnalyzeID", {}).n("TextractClient", "AnalyzeIDCommand").sc(schemas_0.AnalyzeID$).build() {
    };
    var CreateAdapterCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "CreateAdapter", {}).n("TextractClient", "CreateAdapterCommand").sc(schemas_0.CreateAdapter$).build() {
    };
    var CreateAdapterVersionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "CreateAdapterVersion", {}).n("TextractClient", "CreateAdapterVersionCommand").sc(schemas_0.CreateAdapterVersion$).build() {
    };
    var DeleteAdapterCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "DeleteAdapter", {}).n("TextractClient", "DeleteAdapterCommand").sc(schemas_0.DeleteAdapter$).build() {
    };
    var DeleteAdapterVersionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "DeleteAdapterVersion", {}).n("TextractClient", "DeleteAdapterVersionCommand").sc(schemas_0.DeleteAdapterVersion$).build() {
    };
    var DetectDocumentTextCommand2 = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "DetectDocumentText", {}).n("TextractClient", "DetectDocumentTextCommand").sc(schemas_0.DetectDocumentText$).build() {
    };
    var GetAdapterCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetAdapter", {}).n("TextractClient", "GetAdapterCommand").sc(schemas_0.GetAdapter$).build() {
    };
    var GetAdapterVersionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetAdapterVersion", {}).n("TextractClient", "GetAdapterVersionCommand").sc(schemas_0.GetAdapterVersion$).build() {
    };
    var GetDocumentAnalysisCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetDocumentAnalysis", {}).n("TextractClient", "GetDocumentAnalysisCommand").sc(schemas_0.GetDocumentAnalysis$).build() {
    };
    var GetDocumentTextDetectionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetDocumentTextDetection", {}).n("TextractClient", "GetDocumentTextDetectionCommand").sc(schemas_0.GetDocumentTextDetection$).build() {
    };
    var GetExpenseAnalysisCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetExpenseAnalysis", {}).n("TextractClient", "GetExpenseAnalysisCommand").sc(schemas_0.GetExpenseAnalysis$).build() {
    };
    var GetLendingAnalysisCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetLendingAnalysis", {}).n("TextractClient", "GetLendingAnalysisCommand").sc(schemas_0.GetLendingAnalysis$).build() {
    };
    var GetLendingAnalysisSummaryCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "GetLendingAnalysisSummary", {}).n("TextractClient", "GetLendingAnalysisSummaryCommand").sc(schemas_0.GetLendingAnalysisSummary$).build() {
    };
    var ListAdaptersCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "ListAdapters", {}).n("TextractClient", "ListAdaptersCommand").sc(schemas_0.ListAdapters$).build() {
    };
    var ListAdapterVersionsCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "ListAdapterVersions", {}).n("TextractClient", "ListAdapterVersionsCommand").sc(schemas_0.ListAdapterVersions$).build() {
    };
    var ListTagsForResourceCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "ListTagsForResource", {}).n("TextractClient", "ListTagsForResourceCommand").sc(schemas_0.ListTagsForResource$).build() {
    };
    var StartDocumentAnalysisCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "StartDocumentAnalysis", {}).n("TextractClient", "StartDocumentAnalysisCommand").sc(schemas_0.StartDocumentAnalysis$).build() {
    };
    var StartDocumentTextDetectionCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "StartDocumentTextDetection", {}).n("TextractClient", "StartDocumentTextDetectionCommand").sc(schemas_0.StartDocumentTextDetection$).build() {
    };
    var StartExpenseAnalysisCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "StartExpenseAnalysis", {}).n("TextractClient", "StartExpenseAnalysisCommand").sc(schemas_0.StartExpenseAnalysis$).build() {
    };
    var StartLendingAnalysisCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "StartLendingAnalysis", {}).n("TextractClient", "StartLendingAnalysisCommand").sc(schemas_0.StartLendingAnalysis$).build() {
    };
    var TagResourceCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "TagResource", {}).n("TextractClient", "TagResourceCommand").sc(schemas_0.TagResource$).build() {
    };
    var UntagResourceCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "UntagResource", {}).n("TextractClient", "UntagResourceCommand").sc(schemas_0.UntagResource$).build() {
    };
    var UpdateAdapterCommand = class extends smithyClient.Command.classBuilder().ep(commonParams5).m(function(Command, cs, config, o5) {
      return [middlewareEndpoint.getEndpointPlugin(config, Command.getEndpointParameterInstructions())];
    }).s("Textract", "UpdateAdapter", {}).n("TextractClient", "UpdateAdapterCommand").sc(schemas_0.UpdateAdapter$).build() {
    };
    var paginateListAdapters = core.createPaginator(TextractClient2, ListAdaptersCommand, "NextToken", "NextToken", "MaxResults");
    var paginateListAdapterVersions = core.createPaginator(TextractClient2, ListAdapterVersionsCommand, "NextToken", "NextToken", "MaxResults");
    var commands5 = {
      AnalyzeDocumentCommand: AnalyzeDocumentCommand2,
      ...
      DetectDocumentTextCommand: DetectDocumentTextCommand2,
      GetAdapterCommand,
    ...
    var Textract = class extends TextractClient2 {
    };
    smithyClient.createAggregatedClient(commands5, Textract, { paginators });
    var FeatureType2 = {
      FORMS: "FORMS",
      LAYOUT: "LAYOUT",
      QUERIES: "QUERIES",
    ...
    exports2.TextractServiceException = TextractServiceException.TextractServiceException;
    exports2.AdapterVersionStatus = AdapterVersionStatus;
    exports2.AnalyzeDocumentCommand = AnalyzeDocumentCommand2;
    exports2.AnalyzeExpenseCommand = AnalyzeExpenseCommand;
    exports2.AnalyzeIDCommand = AnalyzeIDCommand;
    exports2.AutoUpdate = AutoUpdate;
    exports2.BlockType = BlockType;
    exports2.ContentClassifier = ContentClassifier;
    exports2.CreateAdapterCommand = CreateAdapterCommand;
    exports2.CreateAdapterVersionCommand = CreateAdapterVersionCommand;
    exports2.DeleteAdapterCommand = DeleteAdapterCommand;
    exports2.DeleteAdapterVersionCommand = DeleteAdapterVersionCommand;
    exports2.DetectDocumentTextCommand = DetectDocumentTextCommand2;
    exports2.EntityType = EntityType;
    exports2.FeatureType = FeatureType2;
    exports2.GetAdapterCommand = GetAdapterCommand;
    exports2.GetAdapterVersionCommand = GetAdapterVersionCommand;
    exports2.GetDocumentAnalysisCommand = GetDocumentAnalysisCommand;
    exports2.GetDocumentTextDetectionCommand = GetDocumentTextDetectionCommand;
    exports2.GetExpenseAnalysisCommand = GetExpenseAnalysisCommand;
    exports2.GetLendingAnalysisCommand = GetLendingAnalysisCommand;
    exports2.GetLendingAnalysisSummaryCommand = GetLendingAnalysisSummaryCommand;
    exports2.JobStatus = JobStatus;
    exports2.ListAdapterVersionsCommand = ListAdapterVersionsCommand;
    exports2.ListAdaptersCommand = ListAdaptersCommand;
    exports2.ListTagsForResourceCommand = ListTagsForResourceCommand;
    exports2.RelationshipType = RelationshipType;
    exports2.SelectionStatus = SelectionStatus;
    exports2.StartDocumentAnalysisCommand = StartDocumentAnalysisCommand;
    exports2.StartDocumentTextDetectionCommand = StartDocumentTextDetectionCommand;
    exports2.StartExpenseAnalysisCommand = StartExpenseAnalysisCommand;
    exports2.StartLendingAnalysisCommand = StartLendingAnalysisCommand;
    exports2.TagResourceCommand = TagResourceCommand;
    exports2.TextType = TextType;
    exports2.Textract = Textract;
    exports2.TextractClient = TextractClient2;
    exports2.UntagResourceCommand = UntagResourceCommand;
    exports2.UpdateAdapterCommand = UpdateAdapterCommand;
    exports2.ValueType = ValueType;
    exports2.paginateListAdapterVersions = paginateListAdapterVersions;
    exports2.paginateListAdapters = paginateListAdapters;
...
// backend/src/handlers/extractor.ts
...
var import_client_textract = __toESM(require_dist_cjs53());
var IMAGES_BUCKET = process.env.IMAGES_BUCKET ?? "discharge-images-temp";
var TIMEOUT_MS = 3e4;
  ...
  try {
    ...
    if (isPdf) {
      const result = await Promise.race([
        textract.send(
          new import_client_textract.AnalyzeDocumentCommand({
            Document: document,
            FeatureTypes: [import_client_textract.FeatureType.FORMS]
          })
        ),
        timeoutPromise
      ]);
      ...
      const result = await Promise.race([
        textract.send(new import_client_textract.DetectDocumentTextCommand({ Document: document })),
        timeoutPromise
      ]);
      blocks = result.Blocks ?? [];
    }
    const rawText = blocks.filter((b5) => b5.BlockType === "LINE" && b5.Text).map((b5) => b5.Text).join("\n");
...
var extractHandler = async (event) => {
  let body;
  try {
  ...
  const contentType = event.queryStringParameters?.contentType ?? body.contentType;
  try {
