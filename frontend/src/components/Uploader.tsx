            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {pastDocs.map((cl) => {
                ...
                return (
                  ...
                  >
                    <div>
                      <p style={{ margin: 0, fontSize: 14, fontWeight: 600, color: tokens.textPrimary }}>{date}</p>
                      <p style={{ margin: "2px 0 0", fontSize: 12, color: tokens.textMuted }}>{completed}/{total} items completed</p>
                    </div>
