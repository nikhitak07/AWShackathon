...
export const ChecklistView: React.FC<Props> = ({ checklist, onChange, onNewUpload, username = "" }) => {
...
const s: Record<string, React.CSSProperties> = {
  ...
  title: { margin: 0, fontSize: 28, fontWeight: 700, color: "#1c1c1e", letterSpacing: "-0.5px" },
  newBtn: {
    padding: "9px 18px",
    background: "#007AFF",
    color: "#fff",
